...
class Average:
    ...
    def prob_ave_w_len(self, new_tweet):
        ...
        lens_and_stds = zip(self.ave_word_lengths, self.stdev_ave_word_len_per_tweet)
        print(lens_and_stds)
        # probs = {}
        for ave_len, std in lens_and_stds:
            print(ave_len, std)
        #     probs[] = norm.cdf(new_tweet_ave_w_len, ave_len, std)

a = Average()
a.ave_nwords_per_tweet()
a.ave_word_length()

a.prob_ave_w_len("I have so much stuff to do!!")
